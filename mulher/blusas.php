...
<head>
  ...
  <title>Blusa Feminina | Espaço Masculino</title>
  <meta name="description" content="Default Description">
  <meta name="robots" content="INDEX,FOLLOW">
  <meta name="viewport" content="initial-scale=1.0, width=device-width">
    <meta name="description" content="Conheça nossa coleção de Blusas Femininas. Espaço Masculino, moda do Esportivo ao Social. União da Vitória - PR." />
    ...
    <div class="main-container col2-left-layout">
        ...
        <div class="conteudo">
          ...
          <div class="mix category-1" data-myorder="1">
            <a href="../img/fem/blusas/base-0001.jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/base-0001.jpg">
              <span></span>
            </a>
          </div>
          ...
          <div class="mix category-2" data-myorder="1">
            <a href="../img/fem/blusas/docthos-blusa (1).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/docthos-blusa (1).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-2" data-myorder="2">
            <a href="../img/fem/blusas/docthos-blusa (2).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/docthos-blusa (2).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-2" data-myorder="3">
            <a href="../img/fem/blusas/docthos-blusa (3).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/docthos-blusa (3).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-2" data-myorder="4">
            <a href="../img/fem/blusas/docthos-blusa (4).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/docthos-blusa (4).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-2" data-myorder="5">
            <a href="../img/fem/blusas/docthos-blusa (5).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/docthos-blusa (5).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-2" data-myorder="6">
            <a href="../img/fem/blusas/docthos-blusa (6).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/docthos-blusa (6).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-2" data-myorder="7">
            <a href="../img/fem/blusas/docthos-blusa (7).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/docthos-blusa (7).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-2" data-myorder="8">
            <a href="../img/fem/blusas/docthos-blusa (8).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/docthos-blusa (8).jpg">
              <span></span>
            </a>
          </div>
          ...
          <div class="mix category-3" data-myorder="9">
            <a href="../img/fem/blusas/dudalina-fem (1).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/dudalina-fem (1).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-3" data-myorder="10">
            <a href="../img/fem/blusas/dudalina-fem (2).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/dudalina-fem (2).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-3" data-myorder="11">
            <a href="../img/fem/blusas/dudalina-fem (3).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/dudalina-fem (3).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-3" data-myorder="12">
            <a href="../img/fem/blusas/dudalina-fem (9).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/dudalina-fem (9).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-3" data-myorder="13">
            <a href="../img/fem/blusas/dudalina-fem (15).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/dudalina-fem (15).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-3" data-myorder="14">
            <a href="../img/fem/blusas/dudalina-fem (20).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/dudalina-fem (20).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-3" data-myorder="15">
            <a href="../img/fem/blusas/dudalina-fem (24).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/dudalina-fem (24).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-3" data-myorder="16">
            <a href="../img/fem/blusas/dudalina-fem (25).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/dudalina-fem (25).jpg">
              <span></span>
            </a>
          </div>
          ...
          <div class="mix category-4" data-myorder="17">
            <a href="../img/fem/blusas/poggio-fem (1).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/poggio-fem (1).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-4" data-myorder="18">
            <a href="../img/fem/blusas/poggio-fem (4).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/poggio-fem (4).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-4" data-myorder="19">
            <a href="../img/fem/blusas/poggio-fem (12).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/poggio-fem (12).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-4" data-myorder="20">
            <a href="../img/fem/blusas/poggio-fem (15).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/poggio-fem (15).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-4" data-myorder="21">
            <a href="../img/fem/blusas/poggio-fem (16).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/poggio-fem (16).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-4" data-myorder="22">
            <a href="../img/fem/blusas/poggio-fem (22).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/poggio-fem (22).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-4" data-myorder="23">
            <a href="../img/fem/blusas/poggio-fem (23).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/poggio-fem (23).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-4" data-myorder="24">
            <a href="../img/fem/blusas/poggio-fem (24).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/poggio-fem (24).jpg">
              <span></span>
            </a>
          </div>

          <div class="mix category-4" data-myorder="25">
            <a href="../img/fem/blusas/poggio-fem (34).jpg" class="flipLightBox">
              <img src="../img/fem/blusas/thumbnail/poggio-fem (34).jpg">
              <span></span>
            </a>
          </div>
