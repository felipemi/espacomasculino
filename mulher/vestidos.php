...
<head>
  ...
  <title>Vestido Feminino | Espaço Masculino</title>
  <meta name="description" content="Default Description">
  <meta name="robots" content="INDEX,FOLLOW">
  <meta name="viewport" content="initial-scale=1.0, width=device-width">
  <meta name="description" content="Conheça nossa coleção de Vestidos Femininos. Espaço Masculino, moda do Esportivo ao Social. União da Vitória - PR." />
        ...
        <div class="conteudo">
          ...
          <div class="controls">
            ...
            <div class="centro">
              ...
              <button class="filter active" data-filter=".category-3">Poggio</button>
          ...
          <div class="container">
            ...
            <div class="mix category-1" data-myorder="1">
              <a href="../img/fem/vestidos/base-vestido (1).jpg" class="flipLightBox">
                <img src="../img/fem/vestidos/thumbnail/base-vestido (1).jpg">
                <span>Vestido Base</span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="2">
              <a href="../img/fem/vestidos/base-vestido (2).jpg" class="flipLightBox">
                <img src="../img/fem/vestidos/thumbnail/base-vestido (2).jpg">
                <span>Vestido Base</span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="3">
              <a href="../img/fem/vestidos/base-vestido (3).jpg" class="flipLightBox">
                <img src="../img/fem/vestidos/thumbnail/base-vestido (3).jpg">
                <span>Vestido Base</span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="4">
              <a href="../img/fem/vestidos/base-vestido (4).jpg" class="flipLightBox">
                <img src="../img/fem/vestidos/thumbnail/base-vestido (4).jpg">
                <span>Vestido Base</span>
              </a>
            </div>
            ...
            <div class="mix category-2" data-myorder="5">
              <a href="../img/fem/vestidos/docthos-vestido-01.jpg" class="flipLightBox">
                <img src="../img/fem/vestidos/thumbnail/docthos-vestido-01.jpg">
                <span>Vestido Docthos</span>
              </a>
            </div>

            <!-- Poggio -->

            <div class="mix category-3" data-myorder="6">
              <a href="../img/fem/vestidos/poggio-fem (13).jpg" class="flipLightBox">
                <img src="../img/fem/vestidos/thumbnail/poggio-fem (13).jpg">
                <span>Vestido Poggio</span>
              </a>
            </div>

            <div class="mix category-3" data-myorder="7">
              <a href="../img/fem/vestidos/poggio-fem (31).jpg" class="flipLightBox">
                <img src="../img/fem/vestidos/thumbnail/poggio-fem (31).jpg">
                <span>Vestido Poggio</span>
              </a>
            </div>
