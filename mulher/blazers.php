...
<head>
  ...
  <title>Blazer Feminino | Espaço Masculino</title>
  <meta name="description" content="Default Description">
  <meta name="robots" content="INDEX,FOLLOW">
  <meta name="viewport" content="initial-scale=1.0, width=device-width">
    <meta name="description" content="Conheça nossa coleção de Blazers Femininos. Espaço Masculino, moda do Esportivo ao Social. União da Vitória - PR." />
        ...
        <div class="conteudo">
          ...
          <div class="controls">
            ...
            <div class="centro">
              ...
              <button class="filter active" data-filter=".category-1">Raffer</button>
          ...
          <div class="container">
            ...
            <div class="mix category-1" data-myorder="1">
              <a href="../img/fem/blazers/raffer- (1).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (1).jpg">
                <span></span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="2">
              <a href="../img/fem/blazers/raffer- (2).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (2).jpg">
                <span></span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="3">
              <a href="../img/fem/blazers/raffer- (3).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (3).jpg">
                <span></span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="4">
              <a href="../img/fem/blazers/raffer- (7).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (7).jpg">
                <span></span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="5">
              <a href="../img/fem/blazers/raffer- (8).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (8).jpg">
                <span></span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="6">
              <a href="../img/fem/blazers/raffer- (9).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (9).jpg">
                <span></span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="7">
              <a href="../img/fem/blazers/raffer- (10).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (10).jpg">
                <span></span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="8">
              <a href="../img/fem/blazers/raffer- (11).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (11).jpg">
                <span></span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="9">
              <a href="../img/fem/blazers/raffer- (12).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (12).jpg">
                <span></span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="10">
              <a href="../img/fem/blazers/raffer- (14).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (14).jpg">
                <span></span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="11">
              <a href="../img/fem/blazers/raffer- (15).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (15).jpg">
                <span></span>
              </a>
            </div>

            <div class="mix category-1" data-myorder="12">
              <a href="../img/fem/blazers/raffer- (16).jpg" class="flipLightBox">
                <img src="../img/fem/blazers/thumbnail/raffer- (16).jpg">
                <span></span>
              </a>
            </div>
