...
<head>
  ...
  <title>Blusa Masculina | Espaço Masculino</title>
  <meta name="description" content="Default Description">
  <meta name="robots" content="INDEX,FOLLOW">
  <meta name="viewport" content="initial-scale=1.0, width=device-width">
  <meta name="description" content="Conheça nossa coleção de Blusas Masculinas. Espaço Masculino, moda do Esportivo ao Social. União da Vitória - PR." />
    ...
    <div class="conteudo">
      ...
      <div class="controls">
        ...
        <div class="centro">
          ...
          <button class="filter active" data-filter=".category-1">Highstil</button>
          <button class="filter active" data-filter=".category-2">Zanatta</button>
      ...
      <div class="container">
        ...
        <div class="mix category-1" data-myorder="1">
          <a href="../img/masc/blusas/highstil- (6).jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/highstil- (6).jpg">
            <span>Blusa Masculina Highstil</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="2">
          <a href="../img/masc/blusas/highstil- (7).jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/highstil- (7).jpg">
            <span>Blusa Masculina Highstil</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="3">
          <a href="../img/masc/blusas/highstil- (9).jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/highstil- (9).jpg">
            <span>Blusa Masculina Highstil</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="4">
          <a href="../img/masc/blusas/highstil- (10).jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/highstil- (10).jpg">
            <span>Blusa Masculina Highstil</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="5">
          <a href="../img/masc/blusas/highstil- (19).jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/highstil- (19).jpg">
            <span>Blusa Masculina</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-1.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-1.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-2.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-2.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-3.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-3.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-5.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-5.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-6.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-6.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-7.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-7.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-8.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-8.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-9.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-9.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-10.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-10.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-11.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-11.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-12.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-12.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>

        <div class="mix category-2" data-myorder="5">
          <a href="../img/masc/blusas/zanatta-13.jpg" class="flipLightBox">
            <img src="../img/masc/blusas/thumbnail/zanatta-13.jpg">
            <span>Blusa Masculina Zanatta</span>
          </a>
        </div>
