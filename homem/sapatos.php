...
<head>
  ...
  <title>Sapato Masculino | Espaço Masculino</title>
  <meta name="description" content="Default Description">
  <meta name="robots" content="INDEX,FOLLOW">
  <meta name="viewport" content="initial-scale=1.0, width=device-width">
    <meta name="description" content="Conheça nossa coleção de Sapatos Masculinos. Espaço Masculino, moda do Esportivo ao Social. União da Vitória - PR." />
    ...
    <div class="conteudo">
      ...
      <div class="controls">
        ...
        <div class="centro" style='display: none;'>
          ...
          <button class="filter active" data-filter=".category-1">Andriello</button>
          <button class="filter active" data-filter=".category-2">Ogochi</button>
      ...
      <div class="container">
        ...
        <div class="mix category-1" data-myorder="1">
          <a href="../img/masc/sapatos/andriello-sapatos- (1).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (1).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="2">
          <a href="../img/masc/sapatos/andriello-sapatos- (2).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (2).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="3">
          <a href="../img/masc/sapatos/andriello-sapatos- (3).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (3).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="4">
          <a href="../img/masc/sapatos/andriello-sapatos- (4).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (4).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="5">
          <a href="../img/masc/sapatos/andriello-sapatos- (5).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (5).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="6">
          <a href="../img/masc/sapatos/andriello-sapatos- (6).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (6).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="7">
          <a href="../img/masc/sapatos/andriello-sapatos- (7).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (7).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="8">
          <a href="../img/masc/sapatos/andriello-sapatos- (8).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (8).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="9">
          <a href="../img/masc/sapatos/andriello-sapatos- (9).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (9).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="10">
          <a href="../img/masc/sapatos/andriello-sapatos- (10).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (10).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="11">
          <a href="../img/masc/sapatos/andriello-sapatos- (11).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (11).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="12">
          <a href="../img/masc/sapatos/andriello-sapatos- (12).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (12).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="13">
          <a href="../img/masc/sapatos/andriello-sapatos- (13).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (13).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="14">
          <a href="../img/masc/sapatos/andriello-sapatos- (14).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (14).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="15">
          <a href="../img/masc/sapatos/andriello-sapatos- (15).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (15).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="16">
          <a href="../img/masc/sapatos/andriello-sapatos- (16).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (16).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="17">
          <a href="../img/masc/sapatos/andriello-sapatos- (17).jpg" class="flipLightBox">
            <img src="../img/masc/sapatos/thumbnail/andriello-sapatos- (17).jpg">
            <span>Sapato Andriello</span>
          </a>
        </div>
