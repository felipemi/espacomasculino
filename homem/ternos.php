...
<head>
  ...
  <title>Terno Masculino | Espaço Masculino</title>
  <meta name="description" content="Default Description">
  <meta name="robots" content="INDEX,FOLLOW">
  <meta name="viewport" content="initial-scale=1.0, width=device-width">
    <meta name="description" content="Conheça nossa coleção de Ternos Masculinos. Espaço Masculino, moda do Esportivo ao Social. União da Vitória - PR." />
    ...
    <div class="conteudo">
      ...
      <div class="container">
        ...
        <div class="mix category-1" data-myorder="1">
          <a href="../img/masc/ternos/andriello-ternos- (1).jpg" class="flipLightBox">
            <img src="../img/masc/ternos/thumbnail/andriello-ternos- (1).jpg">
            <span>Terno Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="2">
          <a href="../img/masc/ternos/andriello-ternos- (2).jpg" class="flipLightBox">
            <img src="../img/masc/ternos/thumbnail/andriello-ternos- (2).jpg">
            <span>Terno Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="3">
          <a href="../img/masc/ternos/andriello-ternos- (3).jpg" class="flipLightBox">
            <img src="../img/masc/ternos/thumbnail/andriello-ternos- (3).jpg">
            <span>Terno Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="4">
          <a href="../img/masc/ternos/andriello-ternos- (4).jpg" class="flipLightBox">
            <img src="../img/masc/ternos/thumbnail/andriello-ternos- (4).jpg">
            <span>Terno Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="5">
          <a href="../img/masc/ternos/andriello-ternos- (5).jpg" class="flipLightBox">
            <img src="../img/masc/ternos/thumbnail/andriello-ternos- (5).jpg">
            <span>Terno Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="6">
          <a href="../img/masc/ternos/andriello-ternos- (6).jpg" class="flipLightBox">
            <img src="../img/masc/ternos/thumbnail/andriello-ternos- (6).jpg">
            <span>Terno Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="7">
          <a href="../img/masc/ternos/andriello-ternos- (7).jpg" class="flipLightBox">
            <img src="../img/masc/ternos/thumbnail/andriello-ternos- (7).jpg">
            <span>Terno Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="8">
          <a href="../img/masc/ternos/andriello-ternos- (8).jpg" class="flipLightBox">
            <img src="../img/masc/ternos/thumbnail/andriello-ternos- (8).jpg">
            <span>Terno Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="9">
          <a href="../img/masc/ternos/andriello-ternos- (9).jpg" class="flipLightBox">
            <img src="../img/masc/ternos/thumbnail/andriello-ternos- (9).jpg">
            <span>Terno Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="10">
          <a href="../img/masc/ternos/andriello-ternos- (10).jpg" class="flipLightBox">
            <img src="../img/masc/ternos/thumbnail/andriello-ternos- (10).jpg">
            <span>Terno Andriello</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="11">
          <a href="../img/masc/ternos/andriello-ternos- (11).jpg" class="flipLightBox">
            <img src="../img/masc/ternos/thumbnail/andriello-ternos- (11).jpg">
            <span>Terno Andriello</span>
          </a>
        </div>
