...
<head>
  ...
  <title>Sapatênis Masculino | Espaço Masculino</title>
  <meta name="description" content="Default Description">
  <meta name="robots" content="INDEX,FOLLOW">
  <meta name="viewport" content="initial-scale=1.0, width=device-width">
    <meta name="description" content="Conheça nossa coleção de Sapatênis Masculinos. Espaço Masculino, moda do Esportivo ao Social. União da Vitória - PR." />
    ...
    <div class="conteudo">
      ...
      <div class="controls">
        ...
        <div class="centro" style='display: none;'>
          ...
          <button class="filter active" data-filter=".category-1">Ogochi</button>
      ...
      <div class="container">
        ...
        <div class="mix category-1" data-myorder="1">
          <a href="../img/masc/sapatenis/ogochi-sapatenis- (1).jpg" class="flipLightBox">
            <img src="../img/masc/sapatenis/thumbnail/ogochi-sapatenis- (1).jpg">
            <span>Sapatênis Ogochi</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="2">
          <a href="../img/masc/sapatenis/ogochi-sapatenis- (2).jpg" class="flipLightBox">
            <img src="../img/masc/sapatenis/thumbnail/ogochi-sapatenis- (2).jpg">
            <span>Sapatênis Ogochi</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="3">
          <a href="../img/masc/sapatenis/ogochi-sapatenis- (3).jpg" class="flipLightBox">
            <img src="../img/masc/sapatenis/thumbnail/ogochi-sapatenis- (3).jpg">
            <span>Sapatênis Ogochi</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="4">
          <a href="../img/masc/sapatenis/ogochi-sapatenis- (4).jpg" class="flipLightBox">
            <img src="../img/masc/sapatenis/thumbnail/ogochi-sapatenis- (4).jpg">
            <span>Sapatênis Ogochi</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="5">
          <a href="../img/masc/sapatenis/ogochi-sapatenis- (5).jpg" class="flipLightBox">
            <img src="../img/masc/sapatenis/thumbnail/ogochi-sapatenis- (5).jpg">
            <span>Sapatênis Ogochi</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="6">
          <a href="../img/masc/sapatenis/ogochi-sapatenis- (6).jpg" class="flipLightBox">
            <img src="../img/masc/sapatenis/thumbnail/ogochi-sapatenis- (6).jpg">
            <span>Sapatênis Ogochi</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="7">
          <a href="../img/masc/sapatenis/ogochi-sapatenis- (7).jpg" class="flipLightBox">
            <img src="../img/masc/sapatenis/thumbnail/ogochi-sapatenis- (7).jpg">
            <span>Sapatênis Ogochi</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="8">
          <a href="../img/masc/sapatenis/ogochi-sapatenis- (8).jpg" class="flipLightBox">
            <img src="../img/masc/sapatenis/thumbnail/ogochi-sapatenis- (8).jpg">
            <span>Sapatênis Ogochi</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="9">
          <a href="../img/masc/sapatenis/ogochi-sapatenis- (9).jpg" class="flipLightBox">
            <img src="../img/masc/sapatenis/thumbnail/ogochi-sapatenis- (9).jpg">
            <span>Sapatênis Ogochi</span>
          </a>
        </div>

        <div class="mix category-1" data-myorder="1">
          <a href="../img/masc/sapatenis/ogochi-sapatenis- (10).jpg" class="flipLightBox">
            <img src="../img/masc/sapatenis/thumbnail/ogochi-sapatenis- (10).jpg">
            <span>Sapatênis Ogochi</span>
          </a>
        </div>
